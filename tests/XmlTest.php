...
class XmlTest extends XmlTestCase
{
    ...
    public function provider(): array
    {
        return [
            ...
            [
                Tml::c()->append(null, 'content'),
                'content'
            ],
            [
                Tml::c()->append('', 'content'),
                'content'
            ],
            [
                Tml::c()->append('e'),
            ...
            [
                Hml::c()->append(null, 'content'),
                'content'
            ],
            [
                Hml::c()->append('', 'content'),
                'content'
            ],
            [
                Hml::c()->append('e'),
            ...
            [
                Hml::c()->append('e', 'content'),
                '<e>content</e>'
            ],

            // append(): multiple content
            [
                Tml::c()->append('e', 'lorem', 'ipsum', 'dolor')->setAttributes((new Attributes())->set('foo', 'bar')),
                "<e foo=\"bar\">lorem</e>\n<e>ipsum</e>\n<e>dolor</e>"
            ],

            // append(): indentation
            [
                Tml::c()->append('')->append('e'),
                '<e/>'
            ],
            [
                function () {
            ...
            // inject()
            [
                Hml::createRoot('e')->setAttributes((new Attributes())->set('a', true))
                    ->inject(Nml::createRoot('f')->append('g')
                    ->getRoot()),
                "<e a>\n\t<f xmlns=\"" . Nml::XML_NAMESPACE . "\">\n\t\t<g/>\n\t</f>\n</e>"
            ],
            [
                Hml::createRoot('e')->setAttributes((new Attributes())->set('a', true))
                    ->inject(Tml::c()->append('f')
                    ->getRoot()),
                "<e a>\n\t<f/>\n</e>"
            ],
            ...
            [
                ...
                "<?xml version=\"1.0\" encoding=\"ISO-8859-15\" ?>\r" . Dml::DOCTYPE . "\r<r>\r    <e/>\r</r>"
            ],
            ...
            [
                Tml::c('e')->attrib('a', true),
                '<e a="a"/>'
            ],
            [
                Tml::c('e')->attrib('a', false),
                '<e/>'
            ],
            [
                Hml::c('e')->attrib('a', true),
                '<e a>'
            ],
            [
                Hml::c('e')->attrib('a', false),
                '<e>'
            ],
            [
                Tml::c('e')->attrib('a', Media::ALL()),
                '<e a="all"/>'
            ],
            [
                Tml::c('e')->attrib('a', 1920),
                '<e a="1920"/>'
            ],
            [
                Tml::c('e')->attrib('a', 1.23456),
                '<e a="1.23456"/>'
            ],
