...
class AttributesTest extends TestCase
{
	public function provider(): array
	{
		...
		return [
			...
			[(new Attributes())->set('a'), ' a="a"'],
			[(new Attributes())->set('a', true), ' a="a"'],
			[(new Attributes())->set('a', false), ''],
			[(new Attributes())->set('a', true)->getMarkup(true), ' a'],
			[(new Attributes())->set('a', false)->getMarkup(true), ''],
			[(new Attributes())->set('a', Media::ALL()), ' a="all"'],
			[(new Attributes())->set('a', 1920), ' a="1920"'],
			[(new Attributes())->set('a', 1.23456), ' a="1.23456"'],
